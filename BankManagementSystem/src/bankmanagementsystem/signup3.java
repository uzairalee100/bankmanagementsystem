...
public class signup3 extends JFrame implements ActionListener {
    ...
    String formno;
    JTextField tcardno , tpin ;

    signup3(String formno) {
        this.formno = formno;
        setTitle("NEW ACCOUNT APPLICATION FORM - PAGE 3");

        // Create a panel and set layout to null
        ...
        l4 = new JLabel("XXXX-XXXX-XXXX-5295");
        ...
        //tcardno.setFont(new Font("Raleway", Font.BOLD, 18));
        //tcardno.setBounds(330, 300, 250, 30);
        //panel.add(tcardno);

        tpin = new JTextField();
        tpin.setFont(new Font("Raleway", Font.BOLD, 18));
        tpin.setBounds(330, 370, 250, 30);
        panel.add(tpin);
